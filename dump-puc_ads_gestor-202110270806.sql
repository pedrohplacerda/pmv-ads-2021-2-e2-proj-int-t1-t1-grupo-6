...
--
-- Host: localhost    Database: puc_ads_gestor
-- ------------------------------------------------------
...
CREATE TABLE `tb_endereco` (
  ...
  `id_endereco` char(8) DEFAULT NULL,
  PRIMARY KEY (`cep`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_estoque` (
  `id_produto` char(8) DEFAULT NULL,
  `qntd` decimal(10,0) DEFAULT NULL,
  `em_estoque` tinyint(1) DEFAULT NULL,
  KEY `FK_tb_Produto_tb_Estoque` (`id_produto`),
  CONSTRAINT `FK_tb_Produto_tb_Estoque` FOREIGN KEY (`id_produto`) REFERENCES `tb_produto` (`id_produto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tb_financeiro` (
  `entrada` decimal(20,0) DEFAULT NULL,
  `saida` decimal(20,0) DEFAULT NULL,
  `mesReferente` date DEFAULT NULL,
  `resultado` decimal(20,0) DEFAULT NULL,
  `id_operacao` char(8) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_financeiro`
--
...
CREATE TABLE `tb_produto` (
  `nome_produto` char(25) DEFAULT NULL,
  `preco_produto` decimal(8,0) DEFAULT NULL,
  `categoria` char(8) DEFAULT NULL,
  `id_produto` char(8) NOT NULL,
...
CREATE TABLE `tb_usuario` (
  ...
  `permissao` char(7) DEFAULT NULL,
  `id_usuario` char(8) NOT NULL,
  `nome_empregado` char(20) DEFAULT NULL,
...
--
-- Dumping routines for database 'puc_ads_gestor'
--
...
-- Dump completed on 2021-10-27  8:07:00
